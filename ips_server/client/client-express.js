...
function main() {
  ...
  app.post('/appdata', function(req, res, next) {
    ...
    let devserial = "";
    let rssi_avg = ["0.9637","0.9637","0.9637","0.9637","0.9637","0.9637","0.9637","0.9637","0.9637"];
    let scAddr;
    let scTime = [];
    let sum = 0;
    let avgRssi = 0;
  ...
  app.post('/putdata', function (req, res) {
    ...
    let direction = "";
    let devserial = "";
    let rssi = ["0.9637","0.9637","0.9637","0.9637","0.9637","0.9637","0.9637","0.9637","0.9637"];
    let addr = [
            "d1:c5:f3:61:26:1d",
            "d2:e0:a9:d9:04:22",
            "d8:dc:4b:36:5f:ee",
